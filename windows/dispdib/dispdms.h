/* This file does not appear to be in Watcom's include collection, so we have it here */
/****************************************************************************/
/*                                                                          */
...
#define DisplayDibBegin() DisplayDib(NULL, NULL, DISPLAYDIB_BEGIN|DISPLAYDIB_NOWAIT)
#define DisplayDibEnd()   DisplayDib(NULL, NULL, DISPLAYDIB_END|DISPLAYDIB_NOWAIT)
...
#define DISPLAYDIB_WINDOW_CLASS_CAPS "DISPLAYDIBWINDOW"
...
{
/* NTS: The reason Win32 has to use COPYDATA is because DISPDIB.DLL's window proc assumes lparam is a 16:16 FAR pointer.
	If we send it directly, our 32-bit address is misinterpreted as 16:16 and a crash results */
#if TARGET_MSDOS == 32
        COPYDATASTRUCT cds;
