...
NOW_BUILDING = WINDOWS_DISPDIB_LIB
...
lib: $(WINDOWS_DISPDIB_LIB) .symbolic
...
$(WINDOWS_DISPDIB_LIB): $(SUBDIR)$(HPS)dispdib.obj
	wlib -q -b -c $(WINDOWS_DISPDIB_LIB) -+$(SUBDIR)$(HPS)dispdib.obj

$(HELLO_EXE): $(SUBDIR)$(HPS)hello.obj $(HELLO_RES) $(WINDOWS_W32IMPHK_OBJ) $(WINDOWS_DISPDIB_LIB) $(WINDOWS_DISPDIB_LIB_DEPENDENCIES)
	%write tmp.cmd option quiet system $(WLINK_SYSTEM) $(WINDOWS_DISPDIB_LIB_WLINK_LIBRARIES) file $(SUBDIR)$(HPS)hello.obj
