...
WINDOWS_W32IMPHK_OBJ = ..$(HPS)..$(HPS)windows$(HPS)w32imphk$(HPS)$(SUBDIR)$(HPS)compat.obj
!endif
...
! ifdef TARGET_WINDOWS
$(PLAYMP3_EXE): $(EXT_ZLIB_LIB) $(EXT_FLAC_LIB) $(EXT_SPEEX_LIB) $(EXT_LIBOGG_LIB) $(EXT_VORBIS_LIB) $(EXT_LIBMAD_LIB) $(EXT_FAAD_LIB) $(SUBDIR)$(HPS)playmp3.obj $(SUBDIR)$(HPS)playcom.obj $(SUBDIR)$(HPS)qt.obj $(SUBDIR)$(HPS)qtreader.obj $(HW_CPU_LIB) $(HW_CPU_LIB_DEPENDENCIES) $(HW_DOS_LIB) $(HW_DOS_LIB_DEPENDENCIES) $(PLAYMP3_RES) $(WINDOWS_W32IMPHK_OBJ)
! else
$(PLAYMP3_EXE): $(WIN_W9XVMM_LIB) $(EXT_ZLIB_LIB) $(EXT_FLAC_LIB) $(EXT_SPEEX_LIB) $(EXT_LIBOGG_LIB) $(EXT_VORBIS_LIB) $(EXT_LIBMAD_LIB) $(EXT_FAAD_LIB) $(SUBDIR)$(HPS)playmp3.obj $(SUBDIR)$(HPS)playcom.obj $(SUBDIR)$(HPS)qt.obj $(SUBDIR)$(HPS)qtreader.obj $(HW_SNDSB_LIB) $(HW_SNDSB_LIB_DEPENDENCIES) $(HW_8254_LIB) $(HW_8254_LIB_DEPENDENCIES) $(HW_8259_LIB) $(HW_8259_LIB_DEPENDENCIES) $(HW_CPU_LIB) $(HW_CPU_LIB_DEPENDENCIES) $(HW_DOS_LIB) $(HW_DOS_LIB_DEPENDENCIES) $(HW_VGA_LIB) $(HW_VGA_LIB_DEPENDENCIES) $(HW_8237_LIB) $(HW_8237_LIB_DEPENDENCIES) $(HW_ISAPNP_LIB) $(HW_ISAPNP_LIB_DEPENDENCIES) $(HW_SNDSBPNP_LIB) $(HW_SNDSBPNP_LIB_DEPENDENCIES) $(HW_ULTRASND_LIB) $(HW_ULTRASND_LIB_DEPENDENCIES) $(PLAYMP3_RES) $(WINDOWS_W32IMPHK_OBJ) $(WINDOWS_W9XVMM_LIB)
! endif
	%write tmp.cmd option quiet system $(WLINK_SYSTEM)
! ifdef NEED_W32IMPHK_OBJ
...
! ifndef TARGET_WINDOWS # pure DOS
	%write tmp.cmd $(HW_8254_LIB_WLINK_LIBRARIES) $(HW_8259_LIB_WLINK_LIBRARIES) $(HW_VGA_LIB_WLINK_LIBRARIES) $(HW_SNDSB_LIB_WLINK_LIBRARIES) $(HW_8237_LIB_WLINK_LIBRARIES) $(HW_ISAPNP_LIB_WLINK_LIBRARIES) $(HW_SNDSBPNP_LIB_WLINK_LIBRARIES) $(HW_ULTRASND_LIB_WLINK_LIBRARIES) $(WINDOWS_W9XVMM_LIB_WLINK_LIBRARIES)
! endif
...
$(M4ATOAAC_EXE): $(EXT_ZLIB_LIB) $(SUBDIR)$(HPS)m4atoaac.obj $(SUBDIR)$(HPS)qt.obj $(SUBDIR)$(HPS)qtreader.obj
	%write tmp.cmd option quiet system $(WLINK_SYSTEM) file $(SUBDIR)$(HPS)m4atoaac.obj file $(SUBDIR)$(HPS)qt.obj file $(SUBDIR)$(HPS)qtreader.obj $(EXT_ZLIB_LIB_WLINK_LIBRARIES) name $(M4ATOAAC_EXE)
	@wlink @tmp.cmd
	@$(COPY) ..$(HPS)..$(HPS)dos32a.dat $(SUBDIR)$(HPS)dos4gw.exe
! endif
!endif
