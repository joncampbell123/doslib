...
exe: $(TEST_EXE) $(TPCRAPID_EXE) $(TPCRAPI2_EXE) $(TPCRAPI3_EXE) $(TPCRAPI4_EXE) $(TPCRAPI5_EXE) $(TPCRAPI6_EXE) $(TPCRAPI7_EXE) $(TPCRAPI8_EXE) $(TPCMON1_EXE) $(TPCMON2_EXE) $(TPCRAPND_EXE) $(TPCRAPN2_EXE) .symbolic
...
$(TPCRAPND_EXE): $(HW_8259_LIB) $(HW_8259_LIB_DEPENDENCIES) $(HW_8254_LIB) $(HW_8254_LIB_DEPENDENCIES) $(HW_DOS_LIB) $(HW_DOS_LIB_DEPENDENCIES) $(SUBDIR)$(HPS)tpcrapnd.obj $(SUBDIR)$(HPS)tpcrapid.obj
...
$(TPCRAPN2_EXE): $(HW_8259_LIB) $(HW_8259_LIB_DEPENDENCIES) $(HW_8254_LIB) $(HW_8254_LIB_DEPENDENCIES) $(HW_DOS_LIB) $(HW_DOS_LIB_DEPENDENCIES) $(SUBDIR)$(HPS)tpcrapn2.obj $(SUBDIR)$(HPS)tpcrapi2.obj
