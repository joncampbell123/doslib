...
# define VGATTY_SC_Fn(x)        (0x7F30 + (x))
# define VGATTY_SC_VFn(x)       (0x7F3A + (x))
# define VGATTY_SC_sFn(x)       (0x7F40 + (x))
# define VGATTY_SC_sVFn(x)      (0x7F4A + (x))
# define VGATTY_SC_cFn(x)       (0x7F50 + (x))
# define VGATTY_SC_cVFn(x)      (0x7F5A + (x))
...
#else
# define VGATTY_SC_Fn(x)        (0x3B00 + (x) + ((x) >= 11 ? (0x8500-0x4500) : 0))
# define VGATTY_SC_sFn(x)       (0x5400 + (x) + ((x) >= 11 ? (0x8700-0x5E00) : 0))
# define VGATTY_SC_cFn(x)       (0x5E00 + (x) + ((x) >= 11 ? (0x8900-0x6800) : 0))
