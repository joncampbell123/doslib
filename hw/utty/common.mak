...
$(HW_UTTY_LIB): $(SUBDIR)$(HPS)utty.obj $(SUBDIR)$(HPS)uttystr.obj $(SUBDIR)$(HPS)uttytmp.obj $(SUBDIR)$(HPS)uttyprna.obj $(SUBDIR)$(HPS)drv_pc98.obj
	wlib -q -b -c $(HW_UTTY_LIB) -+$(SUBDIR)$(HPS)utty.obj -+$(SUBDIR)$(HPS)uttystr.obj -+$(SUBDIR)$(HPS)uttytmp.obj -+$(SUBDIR)$(HPS)uttyprna.obj -+$(SUBDIR)$(HPS)drv_pc98.obj
