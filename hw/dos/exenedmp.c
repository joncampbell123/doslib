...
uint16_t ne_name_entry_get_ordinal(struct exe_ne_header_name_entry_table * const t,struct exe_ne_header_name_entry * const ent) {
...
///////////////////
void print_name_table(struct exe_ne_header_name_entry_table * const t) {
