 ...
 *
 * Also this code implements only the LE format. The LX format (which is very similar)
 * is not yet supported.
 *
 * I have not yet tested this against any OS/2 applications or libraries.
 *
 * OS/2 targets generated by DOSLIB are either NE if 16-bit or LS if 32-bit. */
