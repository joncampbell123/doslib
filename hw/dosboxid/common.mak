...
exe: $(TEST_EXE) $(MCR_EXE) $(UMC_EXE) $(UMCN_EXE) $(SSHOT_EXE) $(VCAP_EXE) $(WCAP_EXE) $(KBSTAT_EXE) $(KBINJECT_EXE) $(MSINJECT_EXE) $(ISADMA_EXE) $(IRQ_EXE) $(NMI_EXE) $(IRQINFO_EXE) $(MIXC_EXE) $(EMTIME_EXE) $(WATCHDOG_EXE) .symbolic
