...
#define DOSBOX_ID_8042_KB_STATUS_LED_STATE_MASK	(0xFFUL << 0UL)
#define DOSBOX_ID_8042_KB_STATUS_SCANSET_MASK	(0x3UL << 8UL)
...
#define DOSBOX_ID_8042_KB_STATUS_MOUSE_LBTN	(0x1UL << 18UL)
#define DOSBOX_ID_8042_KB_STATUS_MOUSE_MBTN	(0x1UL << 19UL)
#define DOSBOX_ID_8042_KB_STATUS_MOUSE_RBTN	(0x1UL << 20UL)
