...
uint16_t        vtx86_gpio_intconfig_base_io = 0;
...
int main(int argc,char **argv) {
    ...
    vtx86_gpio_intconfig_base_io = vtx86_sb_readw(0x66);
    if (vtx86_gpio_intconfig_base_io & 1u)
        vtx86_gpio_intconfig_base_io &= ~1u;
    else
        vtx86_gpio_intconfig_base_io  = 0;

    printf("- GPIO Interrupt config, I/O int base:  0x%04x\n",vtx86_gpio_intconfig_base_io);
