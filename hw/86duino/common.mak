...
C_SOURCE =    86duino.c
OBJS =        $(SUBDIR)$(HPS)86duino.obj $(SUBDIR)$(HPS)nb.obj $(SUBDIR)$(HPS)sb.obj $(SUBDIR)$(HPS)sb1.obj $(SUBDIR)$(HPS)mc.obj $(SUBDIR)$(HPS)gpio.obj $(SUBDIR)$(HPS)mcio.obj
TEST_EXE =    $(SUBDIR)$(HPS)test.$(EXEEXT)

$(HW_86DUINO_LIB): $(OBJS)
	wlib -q -b -c $(HW_86DUINO_LIB) -+$(SUBDIR)$(HPS)86duino.obj -+$(SUBDIR)$(HPS)nb.obj -+$(SUBDIR)$(HPS)sb.obj -+$(SUBDIR)$(HPS)sb1.obj -+$(SUBDIR)$(HPS)mc.obj -+$(SUBDIR)$(HPS)gpio.obj -+$(SUBDIR)$(HPS)mcio.obj
