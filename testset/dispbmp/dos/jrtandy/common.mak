...
!ifdef 160X200A_EXE
$(160X200A_EXE): $(FMT_BMP_LIB) $(SUBDIR)$(HPS)160x200a.obj
	%write tmp.cmd option quiet option map=$(160X200A_EXE).map system $(WLINK_CON_SYSTEM) library $(FMT_BMP_LIB) file $(SUBDIR)$(HPS)160x200a.obj name $(160X200A_EXE)
	@wlink @tmp.cmd
...
!ifdef 640X200A_EXE
$(640X200A_EXE): $(FMT_BMP_LIB) $(SUBDIR)$(HPS)640x200a.obj
	%write tmp.cmd option quiet option map=$(640X200A_EXE).map system $(WLINK_CON_SYSTEM) library $(FMT_BMP_LIB) file $(SUBDIR)$(HPS)640x200a.obj name $(640X200A_EXE)
	@wlink @tmp.cmd
