 ...
 * Standard INT 13h mode but with unchained 256-color mode and tweaked 360x240 mode */

static const char bmpfile[] = "240l8v6.bmp";
...
static const uint16_t crtcchg[] = {
	...
	0x4109,		/* maximum scan line register 0x09 */
