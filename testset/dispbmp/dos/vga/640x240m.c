...
/* VGA 640x480 16-color mode with tweaks to make it a 640x240 1bpp mode.
 * Standard INT 13h mode without any tweaks. */

static const char bmpfile[] = "240mc.bmp";
static const char bmpfile2[] = "240m.bmp";
...
int main() {
	...
	outpw(iobase+4,0x4109); /* max scanline */
