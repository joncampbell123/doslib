 ...
 * Standard INT 13h mode but with unchained 256-color mode and tweaked 320x350 mode */

static const char bmpfile[] = "350l8v6.bmp";
...
static const uint16_t crtcchg[] = {
	...
	0xBF06,		/* vertical total 0x06 from 640x480 */
	0x1F07,		/* overflow 0x07 from same */
	0x4009,		/* maximum scan line register 0x09 */
	0x8310,		/* vertical retrace start 0x10 */
