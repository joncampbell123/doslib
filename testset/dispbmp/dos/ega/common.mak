...
!ifdef 640X3504_EXE
$(640X3504_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)640x3504.obj
	%write tmp.cmd option quiet option map=$(640X3504_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)640x3504.obj name $(640X3504_EXE)
	@wlink @tmp.cmd
