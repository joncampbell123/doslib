...
static const char bmpfile[] = "10247681.bmp";
static const char bmpfile2[] = "1024768m.bmp";
static const unsigned int img_width = 1024;
static const unsigned int img_height = 768;
static const unsigned int img_stride = 1024 / 8;
...
int main() {
	...
	/* set 1024x768x16 Tseng ET3k/ET4k */
	__asm {
		mov	ax,0x0037	; AH=0x00 AL=0x37
		int	0x10
	}
