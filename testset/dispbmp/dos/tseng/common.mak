...
!ifdef 320X240B_EXE
$(320X240B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x240b.obj
	%write tmp.cmd option quiet option map=$(320X240B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x240b.obj name $(320X240B_EXE)
	@wlink @tmp.cmd
	@$(COPY) ..$(HPS)..$(HPS)img$(HPS)256$(HPS)w320$(HPS)240vga.bmp $(SUBDIR)$(HPS)320240_8.bmp
	@$(COPY) ..$(HPS)..$(HPS)..$(HPS)..$(HPS)dos32a.dat $(SUBDIR)$(HPS)dos4gw.exe
!endif
...
!ifdef 320X300B_EXE
$(320X300B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x300b.obj
	%write tmp.cmd option quiet option map=$(320X300B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x300b.obj name $(320X300B_EXE)
	@wlink @tmp.cmd
	@$(COPY) ..$(HPS)..$(HPS)img$(HPS)256$(HPS)w320$(HPS)300vga.bmp $(SUBDIR)$(HPS)320300_8.bmp
	@$(COPY) ..$(HPS)..$(HPS)..$(HPS)..$(HPS)dos32a.dat $(SUBDIR)$(HPS)dos4gw.exe
!endif
...
!ifdef 320X350B_EXE
$(320X350B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x350b.obj
	%write tmp.cmd option quiet option map=$(320X350B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x350b.obj name $(320X350B_EXE)
	@wlink @tmp.cmd
	@$(COPY) ..$(HPS)..$(HPS)img$(HPS)256$(HPS)w320$(HPS)350vga.bmp $(SUBDIR)$(HPS)320350_8.bmp
	@$(COPY) ..$(HPS)..$(HPS)..$(HPS)..$(HPS)dos32a.dat $(SUBDIR)$(HPS)dos4gw.exe
!endif
...
!ifdef 320X400B_EXE
$(320X400B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x400b.obj
	%write tmp.cmd option quiet option map=$(320X400B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x400b.obj name $(320X400B_EXE)
	@wlink @tmp.cmd
	@$(COPY) ..$(HPS)..$(HPS)img$(HPS)256$(HPS)w320$(HPS)400vga.bmp $(SUBDIR)$(HPS)320400_8.bmp
	@$(COPY) ..$(HPS)..$(HPS)..$(HPS)..$(HPS)dos32a.dat $(SUBDIR)$(HPS)dos4gw.exe
!endif
...
!ifdef 320X480B_EXE
$(320X480B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x480b.obj
	%write tmp.cmd option quiet option map=$(320X480B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x480b.obj name $(320X480B_EXE)
	@wlink @tmp.cmd
...
!ifdef 320X600B_EXE
$(320X600B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)320x600b.obj
	%write tmp.cmd option quiet option map=$(320X600B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)320x600b.obj name $(320X600B_EXE)
	@wlink @tmp.cmd
...
!ifdef 360X400B_EXE
$(360X400B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)360x400b.obj
	%write tmp.cmd option quiet option map=$(360X400B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)360x400b.obj name $(360X400B_EXE)
	@wlink @tmp.cmd
...
!ifdef 360X480B_EXE
$(360X480B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)360x480b.obj
	%write tmp.cmd option quiet option map=$(360X480B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)360x480b.obj name $(360X480B_EXE)
	@wlink @tmp.cmd
...
!ifdef 360X600B_EXE
$(360X600B_EXE): $(LIBBMP_LIB) $(SUBDIR)$(HPS)360x600b.obj
	%write tmp.cmd option quiet option map=$(360X600B_EXE).map system $(WLINK_CON_SYSTEM) library $(LIBBMP_LIB) file $(SUBDIR)$(HPS)360x600b.obj name $(360X600B_EXE)
	@wlink @tmp.cmd
