...
TARGET_MSDOS = 16
TARGET_WINDOWS = 10
TARGET_WINVER = 0x0100
SUBDIR   = win10$(TARGET86_1DIGIT)$(MMODE)
RC       = *wrc
CC       = *wcc
CXX      = *wpp
LINKER   = *wcl
WLINK_SYSTEM = windows1
WLINK_CON_SYSTEM = windows1
WLINK_DLL_SYSTEM = windows1_dll
RCFLAGS  = -q -r -10 -bt=windows $(WATCOM_INCLUDE) -dNO_DS_SETFONT=1
...
RCFLAGS_DLL = -q -r -10 -bt=windows $(WATCOM_INCLUDE) -dNO_DS_SETFONT=1
