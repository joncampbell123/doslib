...
CFLAGS   = -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -$(CPULEV0) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bg -dWINVER=$(TARGET_WINVER)
CFLAGS386= -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -$(CPULEV3) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bg -dWINVER=$(TARGET_WINVER)
CFLAGS386_TO_586= -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -fp$(CPULEV5) -$(CPULEV5) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bg -dWINVER=$(TARGET_WINVER)
CFLAGS386_TO_686= -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -fp$(CPULEV6) -$(CPULEV6) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bg -dWINVER=$(TARGET_WINVER)
...
CFLAGS_DLL = -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -$(CPULEV0) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bd -dWINVER=$(TARGET_WINVER)
CFLAGS386_DLL = -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -$(CPULEV3) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bd -dWINVER=$(TARGET_WINVER)
CFLAGS386_TO_586_DLL = -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -fp$(CPULEV5) -$(CPULEV5) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bd -dWINVER=$(TARGET_WINVER)
CFLAGS386_TO_686_DLL = -e=2 -zq -zw -zu -m$(MMODE) $(CFLAGS_DEBUG) $(CFLAGS_1) -bt=windows $(CFLAGS_OPT) -wx -fp$(CPULEV6) -$(CPULEV6) -dTARGET_MSDOS=16 -dTARGET_WINDOWS=$(TARGET_WINDOWS) -dMSDOS=1 -dTARGET86=$(TARGET86) -DMMODE=$(MMODE) -q $(WATCOM_INCLUDE) -D_WINDOWS_16_ -bd -dWINVER=$(TARGET_WINVER)
