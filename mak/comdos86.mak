...
CFLAGS += -zdp -zc -g=DGROUP -nt=_TEXT -nc=CODE -DTINYMODE=1 -D__TINY__=1
CFLAGS386 += -zdp -zc -g=DGROUP -nt=_TEXT -nc=CODE -DTINYMODE=1 -D__TINY__=1
CFLAGS386_TO_586 += -zdp -zc -g=DGROUP -nt=_TEXT -nc=CODE -DTINYMODE=1 -D__TINY__=1
CFLAGS386_TO_686 += -zdp -zc -g=DGROUP -nt=_TEXT -nc=CODE -DTINYMODE=1 -D__TINY__=1
!endif
