...
CFLAGS_THIS = -fr=nul -fo=$(SUBDIR)$(HPS).obj -i=.. -i..$(HPS)..$(HPS).. -s -zq -zl -zu -zw -zc -DTARGET_PC98=1
...
! ifeq TARGET_WINDOWS 20
	%write tmp.cmd option description 'DOSBox-X Mouse Pointer Integration driver for Windows 2.0 PC-98'
! endif
! ifeq TARGET_WINDOWS 30
	%write tmp.cmd option description 'DOSBox-X Mouse Pointer Integration driver for Windows 3.0 PC-98'
! endif
! ifeq TARGET_WINDOWS 31
	%write tmp.cmd option description 'DOSBox-X Mouse Pointer Integration driver for Windows 3.1 PC-98'
! endif
