...
;----------------------------------------------
    ...
    segment     _LDATA class=CODE align=4 public use32
...
DBOXMPI_DDB:
                ...
                dd      DBOXMPI_Control                 ; +0x18 DDB_Control_Proc
...
;----------------------------------------------
    ...
    segment     _LTEXT class=CODE align=4 public use32

    global      DBOXMPI_Control
