...
/* ---JC: Testing shows my Pentium 133MHz can handle 44.1KHz stereo
 *        HE-AACv2 SBR real-time using this library----almost. It's
 *        slow enough that combined with GUS output or speaker output
 *        it can fall behind and skip.
 *
 *        Note that the fixed point implementation seems to be even
 *        slower! */
#ifdef TARGET_MSDOS
#undef FIXED_POINT
#endif
