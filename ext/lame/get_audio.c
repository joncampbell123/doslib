...
/* $Id: get_audio.c,v 1.152.2.1 2011/11/18 08:38:04 robert Exp $ */
...
get_audio_common(lame_t gfp, int buffer[2][1152], short buffer16[2][1152])
{
/* NTS: Do *NOT* allocate these on the stack. This causes crashes with Open Watcom's default small stack size. */
    static short buf_tmp16[2][1152];
    static int insamp[2 * 1152];
...
static short const WAVE_FORMAT_PCM = (short)0x0001U;
#endif
#ifndef WAVE_FORMAT_IEEE_FLOAT
static short const WAVE_FORMAT_IEEE_FLOAT = (short)0x0003U;
#endif
#ifndef WAVE_FORMAT_EXTENSIBLE
static short const WAVE_FORMAT_EXTENSIBLE = (short)0xFFFEU;
#endif
