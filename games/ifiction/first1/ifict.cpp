...
# if defined(USE_DOSLIB)
	 ...
	 *      the system is "hung". Write 0xFFFF as a workaround to avoid the hang. Timing will be very slightly off
	 *      (with an error of 1/T8254_REF_CLOCK_HZ per second) as a result. */
