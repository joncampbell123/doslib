...
!ifdef CRAPTN52_EXE
$(CRAPTN52_EXE): $(HW_VGA_LIB) $(HW_VGA_LIB_DEPENDENCIES) $(HW_8254_LIB) $(HW_8254_LIB_DEPENDENCIES) $(HW_8259_LIB) $(HW_8259_LIB_DEPENDENCIES) $(FMT_MINIPNG_LIB) $(FMT_MINIPNG_LIB_DEPENDENCIES) $(HW_SNDSB_LIB) $(HW_SNDSB_LIB_DEPENDENCIES) $(HW_ADLIB_LIB) $(HW_ADLIB_LIB_DEPENDENCIES) $(HW_8237_LIB) $(HW_8237_LIB_DEPENDENCIES) $(COMMON_LIB) $(SUBDIR)$(HPS)craptn52.obj $(SUBDIR)$(HPS)craptnsb.obj $(SUBDIR)$(HPS)craptnlp.obj $(SUBDIR)$(HPS)craptnwt.obj
	%write tmp.cmd option quiet option map=$(CRAPTN52_EXE).map system $(WLINK_CON_SYSTEM) $(HW_VGA_LIB_WLINK_LIBRARIES) $(HW_8254_LIB_WLINK_LIBRARIES) $(HW_8259_LIB_WLINK_LIBRARIES) $(FMT_MINIPNG_LIB_WLINK_LIBRARIES) $(HW_SNDSB_LIB_WLINK_LIBRARIES) $(HW_ADLIB_LIB_WLINK_LIBRARIES) $(HW_8237_LIB_WLINK_LIBRARIES) file $(SUBDIR)$(HPS)craptn52.obj file $(SUBDIR)$(HPS)craptnsb.obj file $(SUBDIR)$(HPS)craptnlp.obj file $(SUBDIR)$(HPS)craptnwt.obj library $(COMMON_LIB) name $(CRAPTN52_EXE)
	@wlink @tmp.cmd
!endif
